...
<div class="container" style="width: 500px; border: #DBDBDB solid 2px; height: 550px; border-radius: 10px;">
  ...
  <form action="conexionselecttipogenero.php" method="POST" class="was-validated">
    <h6>Escribir el nuevo tipo de genero correctamente.</h6>
    <br>
    <div class="form-group">
    <label for="">NUEVO TIPO DE GENERO:</label>
      <input type="text" class="form-control" id="pwd" placeholder="ingresar el nuevo tipo de Genero"  name="genero">
